...
function ScoreOrb({ value }) {
  ...
  return (
    <div className="relative h-60 w-60">
      ...
      <div className="absolute inset-10 flex flex-col items-center justify-center rounded-full bg-[#090d12] shadow-[inset_0_0_50px_rgba(255,255,255,.025)]">
        <span className="text-7xl font-black tracking-[-0.08em] text-white">
          {score % 1 === 0 ? score : score.toFixed(1)}
        </span>
        <span className="mt-2 text-[10px] font-bold uppercase tracking-[0.3em] text-white/35">
          overall score
        </span>
      </div>

      <div className="absolute left-1/2 top-0 h-2.5 w-2.5 -translate-x-1/2 rounded-full bg-cyan-300 shadow-[0_0_18px_rgba(103,232,249,.9)]" />
    </div>
  );
}
...
function TrendChart({ reports }) {
  ...
  if (!values.length) {
    return (
      <div className="flex h-44 items-center justify-center text-xs uppercase tracking-[0.25em] text-white/20">
    ...
    return (
      <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#05070a]/95 backdrop-blur-2xl">
        <div className="relative">
          ...
          <FiActivity className="absolute left-1/2 top-1/2 h-5 w-5 -translate-x-1/2 -translate-y-1/2 text-cyan-300" />
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <header className="flex items-center justify-between border-b border-white/[0.07] px-6 py-6 sm:px-10">
          <div className="flex items-center gap-4">
            <div className="hidden h-9 w-px bg-cyan-300/60 sm:block" />
            <div>
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-11 w-11 items-center justify-center rounded-full border border-white/[0.08] text-white/40 transition hover:border-white/15 hover:bg-white/[0.04] hover:text-white"
          >
        ...
        <main className="p-6 sm:p-10">
          <section className="grid items-end gap-6 border-b border-white/[0.07] pb-10 lg:grid-cols-[1fr_auto]">
            <div>
          ...
          <section className="grid gap-0 border-b border-white/[0.07] lg:grid-cols-[.9fr_1.1fr]">
            <div className="relative flex min-h-[420px] flex-col items-center justify-center border-b border-white/[0.07] py-12 lg:border-b-0 lg:border-r lg:py-10">
              <div className="absolute left-6 top-8 text-[9px] font-bold uppercase tracking-[0.3em] text-white/30">
              ...
              <div className="mt-6 text-center">
                <p className="text-base font-semibold text-white/85">{scoreLabel}</p>
                <div className="mt-2.5 flex items-center justify-center gap-3">
                  ...
                  {improvement > 0 && (
                    <>
                      ...
                      <span className="flex items-center gap-1 text-xs text-emerald-300/80 font-medium">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3">
              {[
                ...
                <div
                  key={label}
                  className={`group border-white/[0.06] p-6 transition hover:bg-white/[0.02] ${
                    index < 3 ? "border-b" : ""
                ...
                >
                  <Icon className="h-5 w-5 text-white/30 transition group-hover:text-cyan-300/80" />
                  <p className="mt-8 text-[10px] font-bold uppercase tracking-[0.22em] text-white/35">
                    {label}
                  </p>
                  <p className="mt-2 text-2xl font-semibold tracking-tight text-white/85">
                    {value}
                  </p>
                </div>
              ))}
          ...
          <section className="grid gap-0 border-b border-white/[0.07] lg:grid-cols-[1.35fr_.65fr]">
            <div className="border-b border-white/[0.07] py-10 lg:border-b-0 lg:border-r lg:pr-10">
              <div className="flex items-end justify-between">
                ...
                <FiTrendingUp className="h-5 w-5 text-white/30" />
              </div>
              ...
              <div className="mt-3 flex justify-between text-[9px] font-bold uppercase tracking-[0.2em] text-white/30">
                <span>Earlier</span>
                <span>Latest</span>
              </div>
            </div>
          ...
          <section className="grid gap-0 border-b border-white/[0.07] lg:grid-cols-[.7fr_1.3fr]">
            <div className="border-b border-white/[0.07] py-10 lg:border-b-0 lg:border-r lg:pr-10">
              ...
              <div className="mt-6 flex items-center gap-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-full border border-cyan-300/20 bg-cyan-300/[0.08]">
              ...
              <div className="mt-8 flex items-end gap-2.5">
                ...
                <span className="mb-2 text-sm font-medium text-white/35">/ 10</span>
              </div>
            </div>
            ...
            <div className="py-10 lg:pl-10">
              ...
              <p className="mt-5 max-w-2xl text-xl leading-8 tracking-[-0.02em] text-white/80">
                {active.description}
              </p>

              <div className="mt-8 border-t border-white/[0.06] pt-6">
                <div className="flex items-start gap-3.5">
                  <FiArrowUpRight className="mt-1 h-5 w-5 text-cyan-300/75 shrink-0" />
          ...
          <section className="pt-10">
            ...
            {reports.length === 0 ? (
              <div className="mt-6 border-y border-dashed border-white/[0.08] py-20 text-center">
                <FiMic className="mx-auto h-6 w-6 text-white/25" />
                <p className="mt-4 text-sm text-white/50">No sessions yet.</p>
              ...
              <div className="mt-6 divide-y divide-white/[0.06] border-y border-white/[0.06]">
                {reports.map((report, index) => {
                  ...
                  return (
                    <div
                      key={report.id || index}
                      className="group grid gap-4 py-5 transition hover:bg-white/[0.018] sm:grid-cols-[90px_1fr_auto] sm:items-center"
                    >
                      <div className="flex items-center gap-3 sm:block">
                        <span className="font-mono text-2xl font-bold tracking-tight text-white/85">
                          {score || "—"}
                        </span>
                        <span className="text-[9px] uppercase tracking-[0.18em] text-white/30 sm:ml-1">
                          /10
                        </span>
                      </div>

                      <div className="min-w-0">
                        <h4 className="truncate text-base font-semibold text-white/75 transition group-hover:text-white">
                      ...
                      <div className="flex items-center gap-6 text-[10px] font-mono text-white/50">
                        ...
                        <FiChevronRight className="h-4 w-4 text-white/25 transition group-hover:text-cyan-300" />
                      </div>
                    </div>
                  );
                })}
          ...
          <footer className="flex items-center justify-between border-t border-white/[0.06] pt-6 mt-10">
            <span className="text-[9px] uppercase tracking-[0.25em] text-white/30">
              GD Arena · Personal intelligence report
            </span>
            <span className="flex items-center gap-2 text-[9px] uppercase tracking-[0.2em] text-white/30">
